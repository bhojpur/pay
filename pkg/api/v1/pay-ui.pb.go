...
func (x *ListEngineSpecsRequest) Reset() {
	*x = ListEngineSpecsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pay_ui_proto_msgTypes[0]
...
func (*ListEngineSpecsRequest) Descriptor() ([]byte, []int) {
	return file_pay_ui_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListEngineSpecsResponse) Reset() {
	*x = ListEngineSpecsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pay_ui_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListEngineSpecsResponse) Descriptor() ([]byte, []int) {
	return file_pay_ui_proto_rawDescGZIP(), []int{1}
}
...
func (x *DesiredAnnotation) Reset() {
	*x = DesiredAnnotation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pay_ui_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DesiredAnnotation) Descriptor() ([]byte, []int) {
	return file_pay_ui_proto_rawDescGZIP(), []int{2}
}
...
func (x *IsReadOnlyRequest) Reset() {
	*x = IsReadOnlyRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pay_ui_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*IsReadOnlyRequest) Descriptor() ([]byte, []int) {
	return file_pay_ui_proto_rawDescGZIP(), []int{3}
}
...
func (x *IsReadOnlyResponse) Reset() {
	*x = IsReadOnlyResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pay_ui_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*IsReadOnlyResponse) Descriptor() ([]byte, []int) {
	return file_pay_ui_proto_rawDescGZIP(), []int{4}
}
...
var File_pay_ui_proto protoreflect.FileDescriptor

var file_pay_ui_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x70, 0x61, 0x79, 0x2d, 0x75, 0x69, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02,
	0x76, 0x31, 0x1a, 0x09, 0x70, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x18, 0x0a,
	...
	0x6f, 0x6e, 0x6c, 0x79, 0x32, 0x96, 0x01, 0x0a, 0x05, 0x50, 0x61, 0x79, 0x55, 0x49, 0x12, 0x4e,
	...
	0x70, 0x75, 0x72, 0x2f, 0x70, 0x61, 0x79, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x2f,
	0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_pay_ui_proto_rawDescOnce sync.Once
	file_pay_ui_proto_rawDescData = file_pay_ui_proto_rawDesc
)

func file_pay_ui_proto_rawDescGZIP() []byte {
	file_pay_ui_proto_rawDescOnce.Do(func() {
		file_pay_ui_proto_rawDescData = protoimpl.X.CompressGZIP(file_pay_ui_proto_rawDescData)
	})
	return file_pay_ui_proto_rawDescData
}

var file_pay_ui_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_pay_ui_proto_goTypes = []interface{}{
...
var file_pay_ui_proto_depIdxs = []int32{
	...
	0, // 2: v1.PayUI.ListEngineSpecs:input_type -> v1.ListEngineSpecsRequest
	3, // 3: v1.PayUI.IsReadOnly:input_type -> v1.IsReadOnlyRequest
	1, // 4: v1.PayUI.ListEngineSpecs:output_type -> v1.ListEngineSpecsResponse
	4, // 5: v1.PayUI.IsReadOnly:output_type -> v1.IsReadOnlyResponse
...
func init() { file_pay_ui_proto_init() }
func file_pay_ui_proto_init() {
	if File_pay_ui_proto != nil {
		return
	}
	file_pay_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_pay_ui_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pay_ui_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pay_ui_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pay_ui_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pay_ui_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pay_ui_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_pay_ui_proto_goTypes,
		DependencyIndexes: file_pay_ui_proto_depIdxs,
		MessageInfos:      file_pay_ui_proto_msgTypes,
	}.Build()
	File_pay_ui_proto = out.File
	file_pay_ui_proto_rawDesc = nil
	file_pay_ui_proto_goTypes = nil
	file_pay_ui_proto_depIdxs = nil
}
